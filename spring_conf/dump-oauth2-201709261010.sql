...
CREATE TABLE `address` (
  ...
  `name` varchar(100) DEFAULT NULL COMMENT '地区名称',
  `code` varchar(10) DEFAULT NULL COMMENT '地区编码',
  `type` int(1) DEFAULT NULL COMMENT '类型',
  `is_del` int(1) DEFAULT '0' COMMENT '是否删除',
  `parent_id` int(11) DEFAULT NULL COMMENT '上级地址',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `address` VALUES (45,'浙江省',NULL,0,0,0,'2017-09-13 23:28:00',NULL),(46,'杭州市',NULL,1,0,45,'2017-09-13 23:28:15',NULL),(47,'西湖区',NULL,2,0,46,'2017-09-13 23:28:28',NULL),(48,'湖北省',NULL,0,0,0,'2017-09-13 23:28:48',NULL),(49,'武汉市',NULL,1,0,48,'2017-09-13 23:29:00',NULL),(50,'武昌区',NULL,2,0,49,'2017-09-13 23:29:10',NULL),(51,'汉口区',NULL,2,0,49,'2017-09-14 07:35:36','2017-09-14 07:35:36'),(52,'江苏省',NULL,0,0,0,'2017-09-13 23:37:18',NULL);
...
CREATE TABLE `permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `permission_name` varchar(100) NOT NULL COMMENT '权限名称',
  `rid` int(11) NOT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`)
...
CREATE TABLE `role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_name` varchar(20) DEFAULT NULL COMMENT '角色',
  PRIMARY KEY (`id`)
...
INSERT INTO `user_` VALUES (21,'29f6004fb1b0466f9572b02bf2ac1be8','2017-09-13 15:36:58',0,'admin@wdcy.cc','21232f297a57a5a743894a0e4a801fc3','028-1234567','admin',1,'2017-09-20 06:20:49'),(22,'55b713df1c6f423e842ad68668523c49','2017-09-05 15:09:43',0,'unity@wdcy.cc','439b3a25b555b3bc8667a09a036ae70c','','unity',0,'2017-09-21 06:20:36'),(23,'612025cb3f964a64a48bbdf77e53c2c1','2017-09-05 15:09:43',0,'mobile@wdcy.cc','532c28d5412dd75bf975fb951c740a30','','mobile',0,'2017-09-20 06:21:12');
...
CREATE TABLE `user_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `rid` int(11) NOT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-09-26 10:10:36
